...
<div class="data-warehouse-inputview">
    ...
    <?php
        ...
        if (isset($_POST["tambah"])||isset($_POST["username"])){
            ...
            if ($_POST['tambah']==NULL && $_POST['username']!=NULL){
                ...
                Yii::$app->db->createCommand("INSERT INTO Warehouse.log_history (kode_barang, username , waktu , jumlah , aktivitas) VALUES ('".$model->kode_barang."','".$username."',current_timestamp, ".$_POST['tambah'].", 'input') ")->execute();
                header("Refresh:0");
            }
        }
    ?>
